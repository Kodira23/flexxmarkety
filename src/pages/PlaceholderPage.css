...
.bot-btn-start-active:hover:not(:disabled) {
  background: #00e8bb;
  box-shadow: 0 0 26px #00d4aa77, 0 6px 16px #00d4aa33;
...
/* Mobile spot */
@media (max-width: 767px) {
  .spot-mobile-tabs { display: grid; }
  .spot-body        { grid-template-columns: 1fr; }
  .spot-header-stats { display: none; }
  .mob-hide         { display: none !important; }
  .spot-chart-area  { height: calc(100vh - 200px); }
  .spot-ob-panel    { height: calc(100vh - 200px); }
  .spot-trade-panel { height: calc(100vh - 200px); }
}
